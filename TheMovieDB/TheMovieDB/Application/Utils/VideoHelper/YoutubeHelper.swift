...
public class Youtube: NSObject {
    ...
    public static func youtubeIDFromYoutubeURL(youtubeURL: URL) -> String? {
        if let youtubeHost = youtubeURL.host {
            ...
            } else if youtubeHost == "youtube.googleapis.com" || youtubeURL.pathComponents.first == "www.youtube.com" as String? {
                return youtubePathComponents[2]
    ...
    public static func h264videosWithYoutubeID(youtubeID: String) -> [String: Any]? {
        ...
        let url = URL(string: "\(urlString)&html5=1")!
     ...
     */
    public static func h264videosWithYoutubeURL(youtubeURL: URL, completion: ((
